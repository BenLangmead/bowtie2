...
#ssh $SF_USER,bowtie-bio@web.sourceforge.net mkdir -p /home/groups/b/bo/bowtie-bio/htdocs/bowtie2
scp -r * $SF_USER,bowtie-bio@web.sourceforge.net:/home/groups/b/bo/bowtie-bio/htdocs/bowtie2/
