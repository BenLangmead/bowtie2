...
public:
	...
	SamConfig(
		...
		print_md_(print_md),
		print_nh_(print_nh),  // # reported alignments
		print_nm_(print_nm),
...
protected:
	...
	// Following are specified in "Sequence Alignment/Map Optional Fields Specification"
	// https://github.com/samtools/hts-specs
	// version: a71164e
	bool print_as_; // AS:i: Alignment score generated by aligner
	bool print_md_; // MD:Z: String for mms. [0-9]+(([A-Z]|\^[A-Z]+)[0-9]+)*2
	bool print_nh_; // NH:i: # reported alignments
